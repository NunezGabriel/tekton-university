            ...
            <div class="flex md:gap-14">
                ...
                <div class="md:flex items-center gap-10">
                    <div>
                        ...
                        <h1 class="font-normal ">apelllido </h1>
                    </div>
                    <div>
                        <h1 class="font-normal ">fecha de nac </h1>
                        <h1 class="font-normal ">edad </h1>
                        <h1 class="font-normal ">profesion </h1>                     
                    </div>
                </div>
            </div>
